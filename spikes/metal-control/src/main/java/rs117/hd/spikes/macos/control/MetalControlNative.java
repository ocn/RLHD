...
final class MetalControlNative implements NativeRendererAccess
{
	...
	@Override public boolean runReadbackCheck(long stateHandle) { return nativeRunReadbackCheck(stateHandle); }
	@Override public long[] close(long stateHandle) { return nativeClose(stateHandle); }
	...
	private static native boolean nativeRunReadbackCheck(long stateHandle);
	private static native long[] nativeClose(long stateHandle);
}
