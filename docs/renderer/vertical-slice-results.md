...
- The full Task 1 fixed zone fixture against an approved numeric golden image.
...
The append-only run evidence is in [panic-investigation-runs.jsonl](panic-investigation-runs.jsonl), runs `R-20260803-001` through `R-20260803-007`.
